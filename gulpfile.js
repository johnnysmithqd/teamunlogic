...
var paths = {
  ...
  sass_main: 'public/assets/styles/main.scss',
  sass_src: 'public/assets/styles/src/**/*',
...
gulp.task('sass', ['clean'], function () {
  ...
  .pipe(sass({style: 'compact', sourcemap: true, errLogToConsole: true, includePaths: ['public/assets/styles/src']}))
